...
class SettingsHeader: UIView {
    ...
    init(user: User) {
        ...
        addSubview(button1)
        button1.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, paddingTop: 16, paddingLeft: 16, paddingRight: 16)
        ...
        addSubview(stack)
        stack.anchor(top: topAnchor, left: button1.rightAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 16, paddingLeft: 16, paddingRight: 16)
    ...
    @objc func handleSelectPhoto(sender: UIButton){
        ...
        print("DEBUG: SENDER TAG: \(sender.tag)")
    }
